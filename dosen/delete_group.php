...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    ...
    if ($stmt_del_group->execute()) {
        ...
        echo "Error deleting group: " . $db->mysqli->error;
    }
