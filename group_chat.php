...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['close_thread'])) {
    ...
    $stmt->execute();
    echo "<script>window.location.href='group_chat.php?id=" . $idthread . "';</script>";
    exit();
}
...
<div class="container">
    ...
    <div class="chat-window" id="chat-box" style="margin-top: 20px;">
    ...
    <?php } else { ?>
        <div class="alert alert-warning"
            style="background:#fff3cd; color:#856404; padding:15px; border-radius:5px; margin-top: 20px;">
...
<script>
    $(document).ready(function () {
        ...
        $('#btn-send').click(function (e) { e.preventDefault(); sendMessage(); });
